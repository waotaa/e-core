...
class NotifyInstrumentModificationJob extends ElasticJob
{
    ...
    public function handle(): void
    {
        ...
        $managers = $trackers
            ->filter(function (InstrumentTracker $tracker) {
                return $tracker->notifyOfModification();
            })
        ...
        $notification = app(InstrumentModifiedNotificationInterface::class, [
