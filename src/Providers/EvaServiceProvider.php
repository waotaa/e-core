...
use Vng\EvaCore\Repositories\Eloquent\ReleaseChangeRepository;
use Vng\EvaCore\Repositories\Eloquent\ReleaseRepository;
...
class EvaServiceProvider extends AggregateServiceProvider
{
    ...
    protected $commands = [
        ...
        KibanaUsersPasswordReset::class,
...
//        ]);
    ...
    private function bindRepositoryInterfaces()
    {
        ...
        $this->app->bind(ReleaseChangeRepositoryInterface::class, ReleaseChangeRepository::class);
