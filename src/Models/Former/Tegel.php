...
class Tegel extends Model
{
    use SoftDeletes;

    protected $table = 'tegels';
    ...
    {
        return $this->belongsToMany(Instrument::class, 'tegel_instrument', 'tegel_id', 'instrument_id')->using(TegelInstrument::class);
    }
}
